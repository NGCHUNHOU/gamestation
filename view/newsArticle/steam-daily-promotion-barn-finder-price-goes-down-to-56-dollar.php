                 ...
                 <head>
                  <title>Steam daily promotion: barn finder price goes down to 56 dollar</title>
                ...
                <header>
                  ...
                  <h3>Steam daily promotion: barn finder price goes down to 56 dollar</h3>
                          </div>
                    </div>
                    <div class='row'>
                      <div class='col-12 mt-4 mb-4'>
                    <img srcset=/gamestation/view/assets/images/news/barn-finder-600.jpg class='article-img' alt='article image'> 
