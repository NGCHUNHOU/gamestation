...
<head>
    <title>GameStation | News </title>
    <meta name="description" content="<?php echo $this->get_siteinfo('description', 'home')?>">
    <meta name="keywords" content="<?php echo $this->get_siteinfo('keywords', 'home')?>">
    <meta name="author" content="<?php echo $this->get_siteinfo('author', 'home')?>">
