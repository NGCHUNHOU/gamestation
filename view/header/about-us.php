...
<head>
    <title>GameStation | About Us </title>
    <meta name="description" content="<?php echo $this->get_siteinfo('description', 'about-us')?>">
    <meta name="keywords" content="<?php echo $this->get_siteinfo('keywords', 'about-us')?>">
    <meta name="author" content="<?php echo $this->get_siteinfo('author', 'about-us')?>">
        ...
        <div class="row">
            <div class="col-md-12 rem-pad">
                <div class="navbar navbar-expand-md navbar-dark bg-logo">
                    <div class="logo navbar-brand"><img src="<?php echo DIR_HOST ?>/view/assets/images/meteor-light-resized.svg" alt="logo" width="32"></div>
