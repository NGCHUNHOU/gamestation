            ...
            <div class="col-md-12 rem-pad">
                <div class="navbar navbar-expand-md navbar-dark bg-logo">
                    ...
                    <ul class="navbar-nav header-list" data-iscapitailse='true'>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo ['DOCUMENT_ROOT']. '/gamestation/'?>" target="_blank">HOME</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo ['DOCUMENT_ROOT']. '/gamestation/about-us/'?>" target="_blank">ABOUT US</a>
                        </li>
                        <li class="nav-item">
