...
<head>
    ...
    <meta name="description" content="<?php echo $this->get_siteinfo('description')?>">
    <meta name="keywords" content="<?php echo $this->get_siteinfo('keywords')?>">
    <meta name="author" content="<?php echo $this->get_siteinfo('author')?>">
